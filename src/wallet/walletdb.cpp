...
bool CWalletDB::WriteZVITSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed)
{
...
bool CWalletDB::ReadZVITSeed(const uint256& hashSeed, std::vector<unsigned char>& seed)
{
